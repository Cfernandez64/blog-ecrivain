...
<li><a class="nav-link" title="Livre d'or" href="/livre-or"><div class="row align-items-center"><div class="picto col"><img src="/images/agenda.png"/></div><div class="item col">&nbsp;Livre d'or</div></div></a></li>
              ...
              <li><a class="nav-link" href="/admin/dashboard/">Admin</a></li>
              <li><a class="nav-link" href="/admin/dashboard/news-insert">Ajouter une news</a></li>
              <li><a class="nav-link" href="/admin/dashboard/deconnexion">Se déconnecter</a></li>
              <?php } ?>
            </ul>
          </nav>
      </header>
